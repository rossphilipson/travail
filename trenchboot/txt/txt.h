...
#define SMX_PARAMETER_NULL		0
#define SMX_PARAMETER_ACM_VERSIONS	1
#define SMX_PARAMETER_MAX_ACM_SIZE	2
#define SMX_PARAMETER_ACM_MEMORY_TYPES	3
#define SMX_PARAMETER_SENTER_CONTROLS	4
#define SMX_PARAMETER_TXT_EXTENSIONS	5

#define SMX_PARAMETER_MAX_VERSIONS	0x20

#define SMX_GET_MAX_ACM_SIZE(v)		((v & ~SMX_PARAMETER_TYPE_MASK)*0x20)

#define SMX_ACM_MEMORY_TYPE_UC		0x00000100
#define SMX_ACM_MEMORY_TYPE_WC		0x00000200
#define SMX_ACM_MEMORY_TYPE_WT		0x00001000
#define SMX_ACM_MEMORY_TYPE_WP		0x00002000
#define SMX_ACM_MEMORY_TYPE_WB		0x00004000

#define SMX_GET_ACM_MEMORY_TYPES(v)	(v & ~SMX_PARAMETER_TYPE_MASK)

#define SMX_GET_SENTER_CONTROLS(v)	((v & 0x7f00) >> 8)

#define SMX_PROCESSOR_BASE_SCRTM	0x00000020
#define SMX_MACHINE_CHECK_HANLDING	0x00000040
#define SMX_GET_TXT_EXT_FEATURES(v)	(v & (SMX_PROCESSOR_BASE_SCRTM|SMX_MACHINE_CHECK_HANLDING))

#define SMX_DEFAULT_VERSION		0x0
#define SMX_DEFAULT_VERSION_MASK	0xffffffff
